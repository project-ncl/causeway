 ...
 */
package org.jboss.pnc.causeway.rest.metrics;
...
public class GeneralRestMetricsFilter implements ContainerRequestFilter, ContainerResponseFilter {
    ...
    private static final String METRICS_RATE_KEY = "causeway.rest.all.rate";

    private static final String METRICS_TIMER_KEY = "causeway.rest.all.timer";
