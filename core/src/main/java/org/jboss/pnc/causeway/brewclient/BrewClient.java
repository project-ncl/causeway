...
public interface BrewClient {
    ...
    /**
     * Find Brew build with given name:version:release that was imported by Causeway. If there isn't any such build, returns null.
     * If there is build with the NVR but it wasn't imported by causeway, CausewayFailure exception is thrown.
     * 
    ...
    /**
     * Find Brew build with given id that was imported by Causeway. If there isn't such build, returns null. If there is build with
